...
from .permissions import IsStaffOrReadOnly, IsNotTestUser, IsAdminForDeleteAndPatchAndReadOnly, IsOwnerOrAdmin     # später hinzufügen!

class ManufacturerList(generics.ListCreateAPIView):
    queryset = Manufacturer.objects.all()
    serializer_class = ManufacturerSerializer
    permission_classes = [IsAuthenticated] #IsStaffOrReadOnly |  IsNotTestUser  # später hinzufügen!

class ManufacturerDetail(generics.RetrieveUpdateDestroyAPIView):
    queryset = Manufacturer.objects.all()
    serializer_class = ManufacturerSerializer
    permission_classes = [IsAdminForDeleteAndPatchAndReadOnly]      # später hinzufügen!
